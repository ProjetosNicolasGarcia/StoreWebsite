<x-profile.layout title="Meus Pedidos">
    <h2 class="text-2xl font-bold mb-6 text-gray-900 border-b border-gray-100 pb-4">Meus Pedidos</h2>
                ...
                <tbody class="divide-y divide-gray-100">
                    @foreach($orders as $order)
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4 font-bold text-black">#{{ $order->id }}</td>
                            ...
                            {{-- Se tiver página de detalhes do pedido, adicione o link aqui --}}
                        </tr>
                    @endforeach
                </tbody>
            </table>
