...
<x-profile.layout title="Meus Favoritos">
    <div class="mb-6">
        <h2 class="text-2xl font-black uppercase tracking-tighter text-gray-900">Meus Favoritos</h2>
            ...
            @foreach($products as $product)
                ...
                <div class="block group relative"
                    ...
                    <div class="relative w-full border border-gray-200 mb-4 bg-white overflow-hidden" style="aspect-ratio: 1 / 1;">
                        ...
                        <button type="button" 
                                class="absolute z-30 transition-colors duration-300 focus:outline-none bg-transparent border-none p-0 m-0 cursor-pointer pointer-events-auto text-red-600 opacity-100"
    ...
    @else
        <div class="text-center py-16 mt-8">
            ...
            <a href="{{ route('home') }}" class="inline-block mt-6 border border-black px-6 py-2 bg-black text-white text-xs font-bold uppercase tracking-widest hover:bg-white hover:text-black transition">Explorar Produtos</a>
        </div>
    @endif
</x-profile.layout>