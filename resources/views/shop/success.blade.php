<x-layout title="Pedido Confirmado">
            ...
            <div class="flex flex-col lg:flex-row gap-8 relative">
                ...
                <div class="w-full lg:w-2/3 space-y-6">
                    ...
                    <section class="bg-white p-6 rounded-none border border-gray-200" aria-labelledby="order-number-title">
                        ...
                        <div class="bg-gray-50 p-4 rounded-none border border-gray-200 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <div class="mt-4 sm:mt-0 text-left sm:text-right">
                                <p class="text-sm text-gray-500 uppercase tracking-widest font-bold">Realizado em</p>
                    ...
                    <section class="bg-white p-6 rounded-none border border-gray-200" aria-labelledby="payment-title">
                        ...
                        @if(in_array($order->payment_method, ['pix', 'boleto']))
                            ...
                            @elseif($order->payment_method === 'boleto')
                                ...
                                <div class="bg-gray-50 p-4 rounded-none border border-gray-200 flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        @else
                            <div class="bg-gray-50 p-4 rounded-none border border-gray-200 flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-bold text-gray-900 uppercase tracking-widest text-xs">Cartão de Crédito</p>
                    ...
                    <section class="bg-white p-6 rounded-none border border-gray-200" aria-labelledby="customer-info-title">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-base text-gray-900 font-bold">{{ $order->user->email }}</p>
                            </div>
                            <div>
                    ...
                    <section class="bg-white p-6 rounded-none border border-gray-200" aria-labelledby="shipping-title">
                        ...
                        <div class="bg-gray-50 p-4 rounded-none border border-gray-200 flex flex-col md:flex-row md:justify-between md:items-center gap-6">
                            @php
                            ...
                            <div class="flex-1">
                                @if($addr)
                                    <p class="font-bold text-gray-900 uppercase">{{ $addr['street'] ?? '' }}, {{ $addr['number'] ?? '' }} @if(!empty($addr['complement'])) - {{ $addr['complement'] }} @endif</p>
                    ...
                    <div class="bg-white p-6 rounded-none border border-gray-200 sticky top-24 relative">
                            ...
                            @foreach($order->items as $item)
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <div class="flex-1 flex flex-col justify-between py-1">
                                        <div>
                                            <p class="font-bold text-sm text-gray-900 line-clamp-2 uppercase">{{ $item->product->name ?? $item->product_name }}</p>
                        ...
                        <div class="border-t border-gray-200 pt-4 space-y-3">
                            ...
                            @if($order->discount > 0.01)
                                <div class="flex justify-between text-sm text-emerald-600 font-bold">
                                    <span class="uppercase tracking-widest text-xs">Desconto de Cupom</span>
                            ...
                            {{-- 4. Frete --}}
                            <div class="flex justify-between text-sm text-gray-600">
                                <span class="uppercase tracking-widest font-bold text-xs">Frete</span>
                            ...
                            {{-- 5. Total Final --}}
                            <div class="flex justify-between items-center pt-4 mt-3 -mx-6 px-6 py-4 border-t border-gray-200">
                                <div>
