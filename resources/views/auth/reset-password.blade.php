<x-layout>
    {{-- Fundo da página alterado para branco (bg-white) --}}
    <div class="min-h-screen flex items-center justify-center bg-white py-12 px-4 sm:px-6 lg:px-8">
        
        {{-- Removido: border, shadow, rounded, bg-white e p-10 --}}
        {{-- Mantido: max-w-md w-full (para limitar a largura e centralizar) --}}
