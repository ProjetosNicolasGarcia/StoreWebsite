...
<body class="bg-white text-gray-900 font-sans antialiased">
    ...
    <header 
        ...
        {{-- Lógica Alpine para Scroll e Pesquisa --}}
        x-data="{ 
        ...
        @endif
    >
        <div class="container mx-auto px-2 sm:px-4 lg:px-8 relative">
            
            {{-- GRID DO CABEÇALHO (Escondido quando a busca está aberta) --}}
            <div class="grid grid-cols-3 items-center" x-show="!searchOpen">
            ...
            {{-- 
                =======================================================
                OVERLAY DE PESQUISA (ATUALIZADO)
                =======================================================
            --}}
            <div x-show="searchOpen" 
                 ...
                 class="absolute inset-0 z-50 bg-white flex items-center px-4 shadow-md h-24" {{-- AUMENTEI A ALTURA PARA h-24 --}}
                 style="display: none;">
                 
                <form action="{{ route('shop.search') }}" method="GET" class="w-full relative max-w-4xl mx-auto flex items-center">
                    
                    {{-- Ícone Lupa (Agora maior e mais escuro) --}}
                    <svg class="h-8 w-8 text-gray-900 mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>

                    {{-- Input Principal (Mais grosso e texto maior) --}}
                    ...
                    {{-- Botão Fechar (X) --}}
                    <button type="button" @click="searchOpen = false; query = ''; suggestions = []" class="ml-4 text-gray-500 hover:text-red-600 transition p-2">
                    ...
                    <div x-show="suggestions.length > 0" 
                         ...
                         class="absolute top-full left-0 right-0 mt-1 bg-white border-t border-gray-100 shadow-xl rounded-b-lg overflow-hidden z-50">
                        <ul>
