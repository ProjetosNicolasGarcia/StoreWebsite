...
<div 
    x-data="{ 
        ...
        birth_date: '',
        errors: {},
        statusMessage: '',  // <--- NOVO: Para mensagem de sucesso
        loading: false,
        showPassword: false, 
        ...
        // --- NOVO MÉTODO PARA RECUPERAR SENHA ---
        async submitForgot() {
            this.loading = true;
            this.errors = {};
            this.statusMessage = ''; // Limpa mensagem anterior
            ...
            try {
                ...
                // Exibe a mensagem de sucesso vinda do backend
        ...
        <div class="p-6">
            ...
            <div x-show="mode === 'register'">
                <form @submit.prevent="submitRegister" class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1">Senha</label>
                        <input type="password" x-model="password" class="block w-full h-12 rounded-xl border border-gray-500 bg-white text-gray-900 shadow-none focus:border-black focus:ring-black transition-all">
                        <p x-show="errors.password" class="text-red-500 text-xs mt-1" x-text="errors.password"></p>
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1">Confirmar Senha</label>
                        <input type="password" x-model="password_confirmation" class="block w-full h-12 rounded-xl border border-gray-500 bg-white text-gray-900 shadow-none focus:border-black focus:ring-black transition-all">
                    </div>
