        ...
        <div class="p-6">
            ...
            <div x-show="mode === '2fa'" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" x-model="code" class="block w-full h-12 text-center tracking-widest text-2xl rounded-none border border-gray-500 bg-white text-gray-900 shadow-none focus:border-black focus:ring-black transition-colors">
                ...
                <form @submit.prevent="submitRegister" class="space-y-4">
                  <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" x-model="name" class="block w-full h-12 px-4 rounded-none border border-gray-500 bg-white text-gray-900 shadow-none focus:border-black focus:ring-black transition-all">
                        ...
                        <div>
                            ...
                            <input type="text" x-model="last_name" class="block w-full h-12 px-4 rounded-none border border-gray-500 bg-white text-gray-900 shadow-none focus:border-black focus:ring-black transition-all">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" x-model="cpf" @input="cpf = formatCPF($el.value)" maxlength="14" placeholder="000.000.000-00" class="block w-full h-12 px-4 rounded-none border border-gray-500 bg-white text-gray-900 shadow-none focus:border-black focus:ring-black transition-all">
                        ...
                        <div>
                            ...
                            <input type="text" x-model="phone" @input="phone = formatPhone($el.value)" maxlength="15" placeholder="(00) 90000-0000" class="block w-full h-12 px-4 rounded-none border border-gray-500 bg-white text-gray-900 shadow-none focus:border-black focus:ring-black transition-all">
                    ...
                    <div>
                        ...
                        <input type="date" x-model="birth_date" max="{{ date('Y-m-d', strtotime('-18 years')) }}" class="block w-full h-12 px-4 rounded-none border border-gray-500 bg-white text-gray-900 shadow-none focus:border-black focus:ring-black transition-all">
                    ...
                    <button type="submit" :disabled="loading" class="w-full h-12 px-4 border border-black rounded-none text-base font-bold text-white bg-black hover:bg-white hover:text-black transition-all cursor-pointer mt-4">
                        CRIAR CONTA
                    </button>
                </form>
            ...
            <div x-show="mode === 'forgot'" class="space-y-5">
                ...
                <form @submit.prevent="submitForgot">
                    ...
                    <button type="submit" :disabled="loading" class="w-full h-12 px-4 border border-black rounded-none text-base font-bold text-white bg-black hover:bg-white hover:text-black transition-all cursor-pointer">
